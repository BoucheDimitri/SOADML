...
\begin{figure}[!tbp]
  \centering
  \subfloat[Loss (log scale) as a function of CPU time on train set]{\includegraphics[width=0.5\textwidth]{Graphs/logloss_cpu_original3_mc100.pdf}}
  \hfill
...
\begin{figure}[!tbp]
  \centering
  \subfloat[Loss (log scale) as a function of CPU time on train set]{\includegraphics[width=0.5\textwidth]{Graphs/logloss_cpu_pca3_mc100.pdf}}
  \hfill
